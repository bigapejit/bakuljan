...
async function main(): Promise<void> {
  ...
  // been completed by a previous iteration, in which case the agent
  // legitimately produces zero new commits and we still want the workflow to
  // proceed (close the sub-issue, advance to the next one).
